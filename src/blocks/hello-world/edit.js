...
export default function Edit(props) {
	...
	return (
		<div {...blockProps}>
			...
			<BlockControls>
				<ToolbarGroup label={__("Media", "example-ghost-org")}>
					{
						...
						media ? (
							<>
								<MediaReplaceFlow
									...
									name={__("Replace Image", "example-ghost-org")}
								/>
							</>
						) : (
								...
								<MediaUpload
									...
									render={({ open }) => (
										<ToolbarButton onClick={open}>
											{__("Add Image", "example-ghost-org")}
										</ToolbarButton>
									)}
								/>
							</MediaUploadCheck>
			...
			<h3 className="hello-world-text">
				<RichText
					...
					placeholder={__("Enter text..", "example-ghost-org")}
