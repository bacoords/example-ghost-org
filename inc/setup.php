...
namespace ExampleGhostOrg\Setup;
...
function theme_setup() {
	...
	* If you're building a theme based on 'example-ghost-org', use a find and replace
	* to change 'example-ghost-org' to the name of your theme in all the template files.
	*/
	load_theme_textdomain( 'example-ghost-org', get_template_directory() . '/languages' );
